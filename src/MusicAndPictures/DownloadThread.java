...
public class DownloadThread extends Thread {
    ...
    @Override
    public void run() {
        File CheekToCheek = new File("C:\\Users\\Elizaveta\\IdeaProjects\\Downloading\\src\\MusicAndPictures\\CheekToCheek.mp3");
        try {
            CheekToCheek.createNewFile();
        } catch (IOException e) {
            e.printStackTrace();
        }
        try (FileInputStream inputStream = new FileInputStream(CheekToCheek.getPath())) {
